    ...
    for(let i=s;i>=0;i--){
        ...
        function getRandomInt(max) {
         ...
         <div class="card__header"> 
           <img style="height:100%; display:inline-block; width: 50%; margin-left:25%;" src="${image[i]}" alt="card__image" class="card-img-top" >
         </div>
         <div class="card__body">
           <span class="tag tag-${colorvalue}">${Type[i]}</span>
           <h4>${Title[i]}</h4>
           <p>${Detail[i]}</p>
         </div>
